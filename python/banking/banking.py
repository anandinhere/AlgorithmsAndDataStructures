...
class Account:
    ...
    def deposit(self,timestamp, amount)-> Optional[int]:
        ...
        if amount <= 0:
            return self.balance
        self.balance += amount
        self.transactions.append(Transaction(timestamp,'deposit',amount,balance=self.balance))
        return self.balance
    ...
    def withdraw(self,timestamp, amount,payment_id)-> Optional[int]:
        ...
        if amount > self.balance:
            return None
        self.balance -= amount
        self.transactions.append(Transaction(timestamp,'withdraw',amount,payment_id,balance=self.balance))
    ...
    def transfer(self, timestamp,amount,account_type):
        ...
        if account_type == 'source':
            self.balance -= amount
            self.totalOutgoingMoney += amount
            self.transactions.append(Transaction(timestamp,'transfer_from',amount,balance=self.balance))
            return self.balance
        else:
            self.balance += amount
            self.transactions.append(Transaction(timestamp,'transfer_to',amount,balance=self.balance))
            return self.balance
...
class Transaction:
    def __init__(self,timestamp,type,amount,payment_id=None,balance=None):
