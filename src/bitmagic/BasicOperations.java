...
public class BasicOperations {
	...
	public static void main(String[] args) {
		...
		String binary = Integer.toBinaryString(Float
				.floatToIntBits(-12345.123f) & 0x7FFFFFFF);
		...
		// - http://bits.stephan-brumme.com/inverse.html here shift is 23. shift
		// by 24 seems to be right.
		...
		System.out.println((1<<bitSize-2));
